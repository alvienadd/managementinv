...
const Customers = React.lazy(() => import('./views/menu/customer/Customer'))
const Pesanan = React.lazy(() => import('./views/menu/pesanan/Pesanan'))
...
const routes = [
  ...
  { path: '/menu', name: 'menu', component: Customers, exact: true },
  { path: '/menu/customer', name: 'Customer', component: Customers },
  { path: '/menu/pesanan', name: 'Pesanan', component: Pesanan },
